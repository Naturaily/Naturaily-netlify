window.addEventListener('load', () => {
  ...
  function initCarousel() {
    ...
    function changeTabPosition(newIndex, $activeDot) {
      ...
      $disabledNav
        .removeClass('case-carousel__nav-item--disabled')
      ...
      if ($disabledNav != null) {
        $disabledNav
          .addClass('case-carousel__nav-item--disabled')
          .attr('data-nav-disabled', 'true')
      }

      $activeDot
        .removeClass('case-carousel__dots-item--active')
        .attr('data-dot-active', 'false');

      $newActiveDot
        .addClass('case-carousel__dots-item--active')
