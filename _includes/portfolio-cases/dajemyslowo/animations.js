...
ScrollTrigger.matchMedia({
  ...
  "(min-width: 992px)": () => {
    const goalPictureTl = gsap.timeline({ scrollTrigger: { trigger: '[data-gsap="picture"]', markers: true } })
    ...
    const solutionPeopleTl =  gsap.timeline({ scrollTrigger: { trigger: '[data-gsap="solution-people"]', markers: true } })
