...
<img src="/assets/images/value-based-pagination-offset.webp" alt="value-based-pagination-offset" height="100%" width="100%">
...
One more real-life situation, where value-based pagination in Rails fits perfectly is SPA chat messages infinite scroll. In a situation when new messages arrive constantly without reloading the page, traditional pagination may have a problem with getting proper results on the first shot. I have tested this in real life app! Time based pagination seems to work really good in this scenario, at least it is much more reliable than a traditional pagination, for sure!
 ...
 <img src="/assets/images/value-based-pagination-where.webp" alt="value-based-pagination-where" height="100%" width="100%">
...
{% image /assets/images/value-based-pagination-value-1.webp value-based-pagination-offset-1 value-based-pagination-offset-1 %}

{% image /assets/images/value-based-pagination-value-2.webp value-based-pagination-offset-2 value-based-pagination-offset-2 %}

{% image /assets/images/value-based-pagination-value-3.webp value-based-pagination-offset-3 value-based-pagination-offset-3 %}
...
{% image /assets/images/value-based-pagination-offset-1.webp value-based-pagination-offset-1 value-based-pagination-offset-1 %}

{% image /assets/images/value-based-pagination-offset-2.webp value-based-pagination-offset-2 value-based-pagination-offset-2 %}

{% image /assets/images/value-based-pagination-offset-3.webp value-based-pagination-offset-3 value-based-pagination-offset-3 %}
