...
<template name="mainLayout">
  <nav class="navbar navbar-default">
    <div class="container">
      <div class="navbar-header">
        {% raw %}{{#linkTo route='root' class='navbar-brand'}}
          Tutorial blog
        {{/linkTo}}{% endraw %}
      </div>
      <ul class="nav navbar-nav">
        <li>
          {% raw %}{{#linkTo route='root'}}
            Home
          {{/linkTo}}{% endraw %}
        </li>
        <li>
          {% raw %}{{#linkTo route='newPost'}}
            Add new post
          {{/linkTo}}{% endraw %}
        </li>
      </ul>
...
<template name="notFound">
  ...
  <p>Go back to our {% raw %}{{#linkTo route='root'}}main page{{/linkTo}}{% endraw %}</p>
</template>
```
